...
export default function PresentationPage() {
  ...
  const slides: Slide[] = [
    // Title Slide
    {
      ...
      background: "bg-gradient-to-br from-primary via-primary-dark to-accent",
        ...
        <div className="text-center">
          <div className="mb-8">
            <HydrationSafeImage 
              ...
              width={150}
              height={150}
              className="mx-auto animate-float-3d"
            />
          </div>
          <h1 className="text-6xl font-bold mb-4 text-white">Baraqex</h1>
        ...
        <div>
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-foreground/80">
              <strong>Result:</strong> 10x faster load times, 90% smaller bundles, 100% developer satisfaction
            </p>
          </div>
        </div>
      )
          ...
          {[
            ...
            >
              ...
              <h4 className="font-bold mb-2 flex items-center gap-2">
                {feature.title}
                {feature.highlight && <StarIcon className="w-4 h-4 text-yellow-500" />}
              </h4>
        ...
        <div className="text-center">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-900 rounded-lg p-1 shadow-2xl">
              ...
              <div className="bg-black text-green-400 p-6 rounded-b-lg font-mono text-left">
                <TypewriterEffect
...
⚡ Ready in 847ms (99% faster than Create React App)`}
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center p-6 bg-blue-100 rounded-lg">
                <div className="text-4xl font-bold text-blue-600 mb-2">23M+</div>
  ...
  return (
    <div ref={presentationRef} className={`min-h-screen ${isFullscreen ? 'bg-black' : ''}`}>
      ...
      <div className={`fixed top-0 left-0 right-0 control-panel z-50 auto-hide ${
        ...
        <div className="container mx-auto px-4 py-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="hidden md:flex items-center gap-1">
                  ...
                  {slides.length > 5 && [slides.length - 2, slides.length - 1].map(index => (
                    <button
                      key={index}
                      onClick={() => setCurrentSlide(index)}
                      className={`w-8 h-8 rounded text-xs font-medium transition-all ${
          ...
          <div className="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-primary to-accent transition-all duration-500 ease-out progress-bar-glow"
      ...
      {/* Presentation Overlay for fullscreen */}
      {isFullscreen && (
